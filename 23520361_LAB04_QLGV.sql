...
SELECT A.MAKHOA, A.TENKHOA FROM (
	SELECT KHOA.MAKHOA, KHOA.TENKHOA, RANK() OVER (ORDER BY KHOA.NGTLAP) RANK_NGTLAP FROM KHOA 
) A
WHERE RANK_NGTLAP = 1

-- 20. Có bao nhiêu giáo viên có học hàm là “GS” hoặc “PGS".
SELECT COUNT(GIAOVIEN.MAGV) AS SOGVCOHOCHAM
FROM GIAOVIEN
WHERE GIAOVIEN.HOCHAM = 'GS' OR GIAOVIEN.HOCHAM = 'PGS';

--21. Thống kê có bao nhiêu giáo viên có học vị là “CN”, “KS”, “Ths”, “TS”, “PTS” trong mỗi khoa.
SELECT COUNT(GIAOVIEN.MAGV) AS SOGVCOHOCVI
FROM  GIAOVIEN
WHERE GIAOVIEN.HOCVI = 'CN' OR HOCVI = 'KS' OR HOCVI = 'Ths' OR HOCVI = 'TS' OR HOCVI = 'PTS';
